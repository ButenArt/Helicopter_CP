...
class Helicopter_TCP_Client_Imager : public TCP_Client  // сетевые пакеты стандартной визуалки убраны за ненадобностью
{
	Q_OBJECT

public:
	Helicopter_TCP_Client_Imager( Helicopter_core* Helicopter, int index = 0);
	~Helicopter_TCP_Client_Imager( );
