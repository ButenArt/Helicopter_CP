#ifndef LP_TCP_CLIENT_H
#define LP_TCP_CLIENT_H
...
class Helicopter_SPU_Left_Pilot_TCP_Client : public TCP_Client
{
    Q_OBJECT

public:
    Helicopter_SPU_Left_Pilot_TCP_Client(Helicopter_core* Helicopter_);
    ~Helicopter_SPU_Left_Pilot_TCP_Client();

    void SendSpuLeftPilotDataPacket(const int track_number);
