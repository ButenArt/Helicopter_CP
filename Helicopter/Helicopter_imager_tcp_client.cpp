...
Helicopter_TCP_Client_Imager::Helicopter_TCP_Client_Imager(Helicopter_core* Helicopter, int index)
{
...
Helicopter_TCP_Client_Imager::~Helicopter_TCP_Client_Imager()
{
}

void Helicopter_TCP_Client_Imager::Start()
{
...
void Helicopter_TCP_Client_Imager::Stop()
{
}

void Helicopter_TCP_Client_Imager::On_Connected()
{
...
void Helicopter_TCP_Client_Imager::On_Disconnected()
{
...
void Helicopter_TCP_Client_Imager::On_Error()
{
    Helicopter->imager->ImagerActive_ = ClientConnected();
    Helicopter->log_->WriteLANLog(LogEvents::TCP_Imager_Error, socketErrorString);
}
void Helicopter_TCP_Client_Imager::On_ReadTcpData()
{
    if ( tcp_port == 8001 )
        ReadTcpDataKlim();
    else
...
void Helicopter_TCP_Client_Imager::ReadTcpDataKlim()
{
...
void Helicopter_TCP_Client_Imager::ReadTcpDataAES()
{
...
void Helicopter_TCP_Client_Imager::On_SendTcpData()
{
...
void Helicopter_TCP_Client_Imager::On_SendPeriodicTcpData()
{
    if (tcp_port == 10000)// для визуалки AES
    {
...
void Helicopter_TCP_Client_Imager::SendExerciseParametersPacket()
{
...
void Helicopter_TCP_Client_Imager::SendObjectsDataPacket()
{
...
void Helicopter_TCP_Client_Imager::SendEnvironmentDataPacket()
{
...
void Helicopter_TCP_Client_Imager::SendTargetsDataPacket()
{
...
void Helicopter_TCP_Client_Imager::SendCommandsDataPacket()
{
...
void Helicopter_TCP_Client_Imager::SendMessagesDataPacket()
{
...
void Helicopter_TCP_Client_Imager::SendTargetsControlDataPacket()
{
...
void Helicopter_TCP_Client_Imager::SendCargoControlDataPacket( )
{
    if ( TcpSocket->state( ) == QAbstractSocket::ConnectedState )
    {
        qDebug( ) << "<--" << __FUNCTION__;
...
void Helicopter_TCP_Client_Imager::SendExitDataPacket( int cause)
{
    qDebug( ) << "<--" << __FUNCTION__;
    if ( TcpSocket->state( ) == QAbstractSocket::ConnectedState )
    {
...
void Helicopter_TCP_Client_Imager::SendAmmoDataPacket()
{
...
void Helicopter_TCP_Client_Imager::SendEffectsDataPacket()
{
    static UINT64 count;
...
void Helicopter_TCP_Client_Imager::SendHelicopterMovingDataPacket()
{
...
void Helicopter_TCP_Client_Imager::SendFireDataPacket()
{
...
//[ ID=103 # Server >> Visual] Стрельба 
// TODO стрельбу лучше сделать эмиттером сигнала, а не постоянным опросом как было у головина
void Helicopter_TCP_Client_Imager::SendPKTFireDataPacket( bool fire )
{
    qDebug() << "<--" << __FUNCTION__;
    if (TcpSocket->state() == QAbstractSocket::ConnectedState)
    {
...
void Helicopter_TCP_Client_Imager::GetImagerState(QDataStream& _stream)
{
...
void Helicopter_TCP_Client_Imager::GetImagerReadyDataPacket(QDataStream& _stream)
{
	qDebug( ) << ">--" << __FUNCTION__;
...
void Helicopter_TCP_Client_Imager::GetImagerElementsStateDataPacket(QDataStream& _stream)
{
    //qDebug() << ">--" << __FUNCTION__;
    const auto& _Imager = Helicopter->imager.data();
...
void Helicopter_TCP_Client_Imager::GetHeightDataPacket(QDataStream& _stream)
{
    //    //qDebug() << ">--" << __FUNCTION__;
...
void Helicopter_TCP_Client_Imager::GetBallisticDataPacket(QDataStream& _stream)
{
    //qDebug() << "-->" << __FUNCTION__;
    const auto& _Imager = Helicopter->imager.data();
...
void Helicopter_TCP_Client_Imager::GetTriggerDataPacket(QDataStream& _stream)
{
    qDebug() << "-->" << __FUNCTION__;
    const auto& _Imager = Helicopter->imager.data();
...
void Helicopter_TCP_Client_Imager::GetMissedEventPacked(QDataStream& _stream)
{
    qDebug() << "-->" << __FUNCTION__;
    const auto& _Imager = Helicopter->imager.data();
...
void Helicopter_TCP_Client_Imager::GetCargoEventPacked( QDataStream& _stream )
{
    qDebug( ) << "-->" << __FUNCTION__;
    const auto& _Imager = Helicopter->imager.data( );
...
void Helicopter_TCP_Client_Imager::GetAmmoEventPacked( QDataStream& _stream )
{
    qDebug( ) << "-->" << __FUNCTION__;
    const auto& _Instructor = Helicopter->instructor.data( );
...
void Helicopter_TCP_Client_Imager::SendHelicopterMovingPacket()
{
    if (TcpSocket->state() == QAbstractSocket::ConnectedState)
    {
        if (tcp_port == 10000) { // для визуалки AES
...
void Helicopter_TCP_Client_Imager::SendHelicopterStartPacket()
{
    if (TcpSocket->state() == QAbstractSocket::ConnectedState)
	{
        QByteArray data;
...
void Helicopter_TCP_Client_Imager::SendHelicopterStatPacket()
{
...
void Helicopter_TCP_Client_Imager::SendHelicopterWeatherPacket()
{
    if (TcpSocket->state() == QAbstractSocket::ConnectedState)
    {
        QByteArray data;
