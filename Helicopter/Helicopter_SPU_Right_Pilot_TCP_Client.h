#ifndef RP_TCP_CLIENT_H
#define RP_TCP_CLIENT_H
...
class Helicopter_SPU_Right_Pilot_TCP_Client : public TCP_Client
{
    Q_OBJECT

public:
    Helicopter_SPU_Right_Pilot_TCP_Client(Helicopter_core* Helicopter_);
    ~Helicopter_SPU_Right_Pilot_TCP_Client();

    void SendSpuRightPilotDataPacket(const int track_number);
