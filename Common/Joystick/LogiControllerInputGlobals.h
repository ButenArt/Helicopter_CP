...
#define LOGICONTROLLERTRACE __noop
    ...
    CONST DWORD PID_X52_JOYSTICK = 0x075C;
    CONST DWORD PID_X52_PEDALS = 0x0765;
    CONST DWORD PID_T1600M_JOYSTICK = 0xB10A;
    CONST DWORD PID_T1600M_THROTTLE = 0xB687;
    ...
    typedef enum
    {
        LG_MANUFACTURER_NONE = -1, LG_MANUFACTURER_LOGITECH, LG_MANUFACTURER_MICROSOFT, LG_MANUFACTURER_SAITEK, LG_MANUFACTURER_OTHER
    } ManufacturerName;
    ...
    typedef enum
    {
        ...
        LG_MODEL_T1600M_JOYSTICK,
        LG_MODEL_T1600M_THROTTLE,
        LG_NUMBER_MODELS
    } ModelName;
