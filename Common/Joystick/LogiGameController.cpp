...
BOOL LogiGameController::IsConnected(CONST ManufacturerName manufacturerName)
{
    ...
    DWORD vid_ = GetVid();
    return TRUE; // TODO отладка для X52 код ниже это какой то бред для защиты логитека
    ...
    else
    {
        ...
        case LG_MANUFACTURER_MICROSOFT:
            ...
            break;
        case LG_MANUFACTURER_SAITEK:
            manufacturer_ = VID_SAITEK;
            break;
        default:
            return FALSE;
        }
...
BOOL LogiGameController::IsConnected(CONST ModelName modelName)
{
    ...
    case LG_MODEL_X52_JOYSTICK: model_ = PID_X52_JOYSTICK; break;
    case LG_MODEL_X52_PEDALS: model_ = PID_X52_PEDALS; break;
    ...
    case LG_MODEL_T1600M_JOYSTICK: model_ = PID_T1600M_JOYSTICK; break;
    case LG_MODEL_T1600M_THROTTLE: model_ = PID_T1600M_THROTTLE; break;
